...
export const LOAD_COMMENT_REQUEST = "POST_COMMENT_REQUEST";
export const LOAD_COMMENT_SUCCESS = "POST_COMMENT_SUCCESS";
export const LOAD_COMMENT_FAIL = "POST_COMMENT_FAIL";